...
public class HyperLinkExtractorTest extends TestCase {

	private HyperLinkExtractor xmlHyperlinkExtractor;
	private String strWithMnthHyperlynk;
	private String strWithMsgUrls;

	protected void setUp() throws Exception {
		xmlHyperlinkExtractor=HyperLinkExtractor.getInstance();
