...
public class MailDownloadHelperImplTest extends TestCase {
	...
	public void testMailFileDwnldHelperImpForDirName() {
		String expected="null/YEAR_14/MONTH_Dec";
	...
	public void testMailFileDwnldHelperImpForFileName(){
		String expected="\"Bateman, Patrick eMEDIA\" <Patrick.Bateman@mytravel.com> + RE: JUnit Test Converage Reporting + Mon Dec  1 07:40:31 2014";
